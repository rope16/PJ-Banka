...
public class ClientLoanForm extends javax.swing.JFrame {
    ...
    public ClientLoanForm(Guest guest){
        this.guest = guest;
        initComponents();
        loadLoansToTable();
    }
    ...
    public void loadLoansToTable(){
         dbFunctions.Connect();
         loanList = dbFunctions.GetLoanForClient(guest.getID());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClientLoanForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClientLoanForm().setVisible(true);
            }
        });
    }
